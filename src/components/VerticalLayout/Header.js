...
const Header = props => {
  ...
  function toggleFull() {
    if (
      !document.fullElement &&
      /* alternative standard method */ !document.mozFullElement &&
      !document.webkitFullElement
    ) {
      // current working methods
      if (document.documentElement.requestFull) {
        document.documentElement.requestFull();
      } else if (document.documentElement.mozRequestFull) {
        document.documentElement.mozRequestFull();
      } else if (document.documentElement.webkitRequestFull) {
        document.documentElement.webkitRequestFull(
          Element.ALLOW_KEYBOARD_INPUT
        );
      }
    } else {
      if (document.cancelFull) {
        document.cancelFull();
      } else if (document.mozCancelFull) {
        document.mozCancelFull();
      } else if (document.webkitCancelFull) {
        document.webkitCancelFull();
      }
    }
  }
